...
MS_ACTIVITIES = [
    ...
    ("lab04/lab04_ms_short.ipynb",
        "⚙️ Lab 04",   "Functions and Visualization"),
...
CHEMISTREES = [
    ...
    ("Chemistry/CopperPhosphate/practice_stoich.ipynb", "Stoichiometry Problems", "Some more fun problems :)"),
    ("Chemistry/BurningFood/BurningFood.ipynb", "Burning Food Postlab", "It's a Scientist's job to set things on fire"),
    ("Chemistry/HeatCurve/HeatingCurve.ipynb", "Heating Curve Postab", "Climate Change?")],
    ...
    ("Chemistry/Tea/Fluoride Postlab Analysis.ipynb", "Tea: Fluoride UV-vis Postlab", "I love fluoride :D"),
